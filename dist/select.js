  ...
  return {
    ...
    compile: function(tElement, tAttrs) {
      ...
      return function(scope, element, attrs, ctrls, transcludeFn) {
        ...
        //CW NOTE: Temp fix for tagging label keyup. Pulled and removed from uiSelectMultiple; removed from uiSelectMultiple because we are only using single... may want to move this into its own uis service if we need this to work in uiSelectMultiple
        ...
        $select.searchInput.on('keyup', function(e) {
          ...
          if ( $select.tagging.isActivated && $select.search.length > 0 ) {
            ...
            if ( $select.tagging.fct === undefined) { // CW Note: bypassed this because we are leveraging the "tagging" function.. default directive will not apply data to model. original comparator is "!==""
